...
function saveANewSnip() {
	//NOTE: this function (regretably) modifies a global variable! Specifically, it will put the id of the snip that it saves in the "idOfSnipIfAlreadySaved" global!
	...
	chrome.tabs.query({ active: true, currentWindow: true }, async function (tabs) {
		...
		// save our new snip away in the database
...
saveButton.onclick = async function () {
	// NOTE: this functions references the idOfSnipIfAlreadySaved global!
